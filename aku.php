...
echo color("green", "# # # # # # # # # # # # # # # # # # # # # # # \n");
echo color("blue", "[•]  jam  : " . date('[d-m-Y] [H:i:s]') . "   \n");
echo color("blue", "[•]              tungguin aja!!           \n");
echo color("blue", "[•]     tulis nomor pakai 62xxxxxxxxxx    \n");
echo color("blue", "[•]     JANGAN DIPERJUAL BELIKAN !!!!!    \n");
echo color("green", "# # # # # # # # # # # # # # # # # # # # # # # \n");
function change()
{
        $nama = nama();
        ...
        if (strpos($register, '"otp_token"')) {
                ...
                if (strpos($verif, '"access_token"')) {
                        ...
                        if ($pilihan == "y" || $pilihan == "Y") {
                                ...
                                if (strpos($code1, 'Gasss...')) {
                                        echo "\n" . color("green", "+] Message: " . $message);
                                        goto gocar;
                                } else {
                                        echo "\n" . color("red", "-] Message: " . $message);
                                        gocar:
                                        echo "\n" . color("yellow", "!] Claim voc GOFOOD Kalo Hoki 50%");
                                        echo "\n" . color("yellow", "!] Tungguin..");
                                        for ($a = 1; $a <= 3; $a++) {
                                                echo color("yellow", ".");
                                                sleep(20);
